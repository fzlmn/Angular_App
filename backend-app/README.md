...
```java
// src/main/java/com/aymane/backendapp/entities/Product.java
@Entity
...
```java
// src/main/java/com/aymane/backendapp/repositories/ProductRepository.java
...
```java
// src/main/java/com/aymane/backendapp/web/ProductRestAPI.java
@RestController
@CrossOrigin("*")
@RequestMapping("/api")
@AllArgsConstructor
...
```java
// src/main/java/com/aymane/backendapp/BackendAppApplication.java
@Bean
